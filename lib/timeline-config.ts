...
export const MILESTONE_STATS: MilestoneStat[] = [
  ...
  {
    hook: "The digital revolution connected the world. Growth lifted billions — but inequality grew too.",
    context: "The Cold War ended. The internet emerged. Cell phones spread across continents. Globalization accelerated trade and lifted unprecedented numbers out of poverty, but environmental degradation and inequality emerged as the new frontiers of crisis.",
    keyFact: "Between 1990 and 2015, extreme poverty fell from 36% to 10%. The number of people connected to the internet grew from millions to billions.",
    poverty: 36,
    lifeExpectancy: 64,
    childMortality: 93,
    literacy: 75,
